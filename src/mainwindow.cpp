...
void MainWindow::openCirc()
{
    ...
    QString fileName = QFileDialog::getOpenFileName( this, tr("Load Circuit"), dir,
...
void MainWindow::createToolBars()
{
    ...
    fileToolBar->addAction(newCircAct);
    fileToolBar->addAction(openCircAct);
    fileToolBar->addAction(saveCircAct);
    fileToolBar->addAction(saveCircAsAct);

    circToolBar = addToolBar(tr("Circuit"));
